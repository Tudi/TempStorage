...
if($errId === NO_ERR)
{
	...
	$rows = executeMySQLQuery("INSERT INTO OrganizationModules (OrganizationID,ModuleInstanceID) values (
	$OrganizationId, $ModuleInstanceID)");		
}
...
// log API usage 
LogAPIUsage(LOG_SOURCE_USER_ACTION, LOG_SEVERITY_NORMAL, "Created organization module. Err = $errId" );
