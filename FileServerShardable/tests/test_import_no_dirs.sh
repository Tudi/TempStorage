...
# run the server
../fs_server_app/bin/fs_server_app --log_level debug --server_id 666275 --num_servers 1 --num_entries_per_file 2 --port $PORT --num_connections 2 --request_arrival_timeout 300000 --connection_timeout 2000 --data_dir ./data --dir_depth 1 --dir_count 2 2 &
pid1=$!
...
compareResultFile "1.expected" "./data/1/0"
compareResultFile "2.expected" "./data/2/0"
compareResultFile "3.expected" "./data/3/1"
compareResultFile "4.expected" "./data/4/561728"
