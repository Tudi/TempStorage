...
try:
    ...
    while True:
        ...
        buffer = add_klv(buffer, key=0x03, value=counter_bytes) # testing filtering
        
        if counter % 2 == 1 :
            buffer = add_klv(buffer, key=0x04, value=counter_bytes) # testing multi value filtering with random appearance
