...
void ProjectNotificationCallback(int ErrorCode, char *ErrorString)
{
	printf("Notification received callback code %d and callback string %s\n\n", ErrorCode, ErrorString);
}
...
int main()
{
	...
	NotificationRegister(&ProjectNotificationCallback);
